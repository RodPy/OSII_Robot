"""
gaussmeter_reader.py
Adaptación de trabajo de Asiimwe Robert. Comunicación con magnetómetro vía serial (abrir puerto, leer intensidad de campo, cerrar).
Adaptation of Asiimwe Robert's work. Magnetometer communication via serial (open port, read field strength, close).
Author: Rodney Rojas
Sustainable MRI Lab
February 2026
Version: 1.1
